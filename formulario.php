...
<form action="formulario.php" class="row g-3" method="post">
    ...
    <div class="col-md-6">
        <input type="submit" name="guardar" value="guardar" class="bg-warning">
    </div>
</form>
    ...
    <?php
        if(isset($_POST['guardar']))
        {
            ...
            //$_post['name'] --> . document.getelement....
            $id=$_POST['id'];
            $nombre=$_POST['nombre'];
            ...
            mysqli_query($configuracion,"INSERT INTO registro(id,nombre,apellido,telefono,fecha,correo) VALUES('$id','$nombre','$apellido','$telefono','$fecha','$correo')");
